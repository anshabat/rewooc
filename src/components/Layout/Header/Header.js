      ...
      <div className="rw-header__main">
        <div className="rw-header__container">
          <div className="rw-header__main-row">
            <div className="rw-header__main-left">{props.mainLeft}</div>
            <div className="rw-header__main-center">{props.mainCenter}</div>
            <div className="rw-header__main-right">{props.mainRight}</div>
          </div>
        </div>
      </div>
